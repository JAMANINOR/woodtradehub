            ...
            <div class="col-xl-3 col-md-6 col-lg-3 noPaddingRight">
                <aside class="widget">
                    <div class="about_widget">
                        <a href="{{ url('/') }}"><img src="{{ asset('images/LOGO PERUSAHAAN 1.png') }}" alt="" width="100" /></a>
                        <p>
                ...
                <aside class="widget">
                    ...
                    <div class="recentServices">
                        <div class="serviceItem clearfix">
                            <img src="{{ asset('images/widget/1.jpg') }}" alt="" width="100" class="float-left" />
                            <h5><a href="#">Export Management Services.</a></h5>
                            <span>&nbsp;</span>
                        </div>
                        <div class="serviceItem clearfix">
                            <img src="{{ asset('images/widget/2.jpg') }}" alt="" width="100" class="float-left" />
                            <h5><a href="#">Global Shipping Solutions.</a></h5>
                            <span>&nbsp;</span>
                        </div>
                        <div class="serviceItem clearfix">
                            <img src="{{ asset('images/widget/3.jpg') }}" alt="" width="100" class="float-left" />
